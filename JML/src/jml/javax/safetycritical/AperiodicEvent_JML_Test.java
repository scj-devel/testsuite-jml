/*
 * Test Oracle Class for jml.javax.safetycritical.AperiodicEvent
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-17 02:12 +0200.
...
import jml.javax.safetycritical.AperiodicEvent_JML_Data.*;


/**
 * Test oracles generated by JMLUnitNG for JML4 RAC of class
 * jml.javax.safetycritical.AperiodicEvent.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-17 02:12 +0200
 */

public class AperiodicEvent_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {AperiodicEvent_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.AperiodicEvent.class),
     "JMLUnitNG tests can only run on RAC-compiled code.");
  } 

  /**
   * A test for method setActive.
   *
   * @param the_test_object The AperiodicEvent to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_setActive__0
  (final jml.javax.safetycritical.AperiodicEvent the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
      }
    try {
      the_test_object.setActive();
    }
  ...
  /**
   * A test for method fire.
   *
   * @param the_test_object The AperiodicEvent to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_fire__0
  (final jml.javax.safetycritical.AperiodicEvent the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
   ...
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_AperiodicEvent__0
  () {
    try {
      new jml.javax.safetycritical.AperiodicEvent();
    }
    catch (final JMLEntryPreconditionError $e) {
      // meaningless test
      throw new PreconditionSkipException($e.getMessage());
  ...
  /**
   * A test for method removeHandler.
   *
   * @param the_test_object The AperiodicEvent to call the test method on.
   * @param handler The AperiodicEventHandler to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_removeHandler__AperiodicEventHandler_handler__25")
  public void test_removeHandler__AperiodicEventHandler_handler__25
  (final jml.javax.safetycritical.AperiodicEvent the_test_object, 
   final jml.javax.safetycritical.AperiodicEventHandler handler) {
    ...
    try {
      the_test_object.removeHandler(handler);
    }
    catch (final JMLEntryPreconditionError $e) {
      // meaningless test
      throw new PreconditionSkipException($e.getMessage());
  ...
  /**
   * A test for method addHandler.
   *
   * @param the_test_object The AperiodicEvent to call the test method on.
   * @param handler The AperiodicEventHandler to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_addHandler__AperiodicEventHandler_handler__25")
  public void test_addHandler__AperiodicEventHandler_handler__25
  (final jml.javax.safetycritical.AperiodicEvent the_test_object, 
   final jml.javax.safetycritical.AperiodicEventHandler handler) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
    ...
    try {
      the_test_object.addHandler(handler);
    }
    catch (final JMLEntryPreconditionError $e) {
      // meaningless test
      throw new PreconditionSkipException($e.getMessage());
  ...
  /**
   * Data provider for method void removeHandler(AperiodicEventHandler).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_removeHandler__AperiodicEventHandler_handler__25", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_removeHandler__AperiodicEventHandler_handler__25() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (AperiodicEvent_InstanceStrategy.class,
          removeHandler__AperiodicEventHandler_handler__25__handler.class));
  }


  /**
   * Data provider for method void addHandler(AperiodicEventHandler).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_addHandler__AperiodicEventHandler_handler__25", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_addHandler__AperiodicEventHandler_handler__25() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (AperiodicEvent_InstanceStrategy.class,
          addHandler__AperiodicEventHandler_handler__25__handler.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(AperiodicEvent_InstanceStrategy.class));
  }
}