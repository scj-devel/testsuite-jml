/*
 * Test Oracle Class for jml.javax.safetycritical.AsyncEvent
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-17 02:03 +0200.
 ...
 * jml.javax.safetycritical.AsyncEvent.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-17 02:03 +0200
 */

public class AsyncEvent_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {AsyncEvent_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.AsyncEvent.class),
  ...
  public void test_AsyncEvent__0
  () {
    try {
      new jml.javax.safetycritical.AsyncEvent();
    }
   ...
   *
   * @param the_test_object The AsyncEvent to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_fire__0
  (final jml.javax.safetycritical.AsyncEvent the_test_object ) {
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(AsyncEvent_InstanceStrategy.class));
  }
}