...
public abstract class Clock 
{
  ...
  /*@ 
    public behavior
      requires drivesEvents() && time != null && time.compareTo(getTime())== 1;
      requires clockEvent != null;
      ensures true;
    @*/
  @SCJAllowed(Level.LEVEL_1)
  public abstract void registerCallBack(AbsoluteTime time, ClockCallBack clockEvent);
