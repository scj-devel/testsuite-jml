/*
 * Test Oracle Class for jml.javax.safetycritical.Clock
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-17 05:54 +0200.
 ...
 * jml.javax.safetycritical.Clock.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-17 05:54 +0200
 */

public class Clock_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {Clock_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.Clock.class),
     "JMLUnitNG tests can only run on RAC-compiled code.");
  } 

  /**
   * A test for method getRealtimeClock.
   *
   * @param the_test_object The Clock to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_static_getRealtimeClock__0
  ( ) {
    try {
      jml.javax.safetycritical.Clock.getRealtimeClock();
    }
