...
import jml.javax.safetycritical.PackageStrategy_jml_javax_safetycritical_HighResolutionTime;
/**
 * Test data strategy for jml.javax.safetycritical.HighResolutionTime. Provides
 * class-scope test values for type jml.javax.safetycritical.HighResolutionTime.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-14 10:55 +0200
 */
public class ClassStrategy_jml_javax_safetycritical_HighResolutionTime 
  extends PackageStrategy_jml_javax_safetycritical_HighResolutionTime {
  /**
   * @return class-scope values for type jml.javax.safetycritical.HighResolutionTime.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
  	 { /* add class-scope jml.javax.safetycritical.HighResolutionTime values or generators here */ });
  }
   ...
   */
  public ClassStrategy_jml_javax_safetycritical_HighResolutionTime() {
    super();
    setReflective(false);
