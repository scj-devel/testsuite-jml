 ...
 * instances of jml.javax.safetycritical.ManagedMemory for testing, using
 * parameters from constructor tests.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 02:28 +0200
 */
public class ManagedMemory_InstanceStrategy extends ObjectStrategy {
  /**
   * @return local-scope instances of ManagedMemory.
   */
  public RepeatedAccessIterator<?> localValues() {
    return new ObjectArrayIterator<Object>
    (new Object[]
     { /* add jml.javax.safetycritical.ManagedMemory values or generators here */ });
  }

  /**
   * @return default instances of ManagedMemory, generated
   *  using constructor test parameters.
   */ 
  public RepeatedAccessIterator<jml.javax.safetycritical.ManagedMemory> defaultValues() {
    // abstract classes cannot be constructed
    return new ObjectArrayIterator<jml.javax.safetycritical.ManagedMemory>(new jml.javax.safetycritical.ManagedMemory[0]);
  }
   ...
   */
  public ManagedMemory_InstanceStrategy() {
    super(jml.javax.safetycritical.ManagedMemory.class);
    setReflective(false);
