 ...
 */
public class enterPrivateMemory__int_size__Runnable_logic__10__logic
   ...
   * "Runnable logic" of method "void enterPrivateMemory(int, Runnable)" 
   ...
   */
  public enterPrivateMemory__int_size__Runnable_logic__10__logic() {
    super();
