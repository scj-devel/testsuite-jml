...
import jml.javax.safetycritical.PackageStrategy_jml_javax_safetycritical_HandlerSet;
/**
 * Test data strategy for jml.javax.safetycritical.MissionMemory. Provides
 * class-scope test values for type jml.javax.safetycritical.HandlerSet.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 01:44 +0200
 */
public class ClassStrategy_jml_javax_safetycritical_HandlerSet 
  extends PackageStrategy_jml_javax_safetycritical_HandlerSet {
  /**
   * @return class-scope values for type jml.javax.safetycritical.HandlerSet.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
  	 { /* add class-scope jml.javax.safetycritical.HandlerSet values or generators here */ });
  }

  /**
   * The use of reflection can be controlled here for  
   * parameters of type jml.javax.safetycritical.HandlerSet
   ...
   */
  public ClassStrategy_jml_javax_safetycritical_HandlerSet() {
    super();
    setReflective(false);
