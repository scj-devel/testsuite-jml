 ...
 * package-scope test values for type jml.javax.safetycritical.AperiodicEventHandler.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-04-08 08:42 +0200
 */
public class PackageStrategy_jml_javax_safetycritical_AperiodicEventHandler 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type jml.javax.safetycritical.AperiodicEventHandler.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope jml.javax.safetycritical.AperiodicEventHandler values or generators here */ });
  }
   ...
   */
  public PackageStrategy_jml_javax_safetycritical_AperiodicEventHandler() {
    super(jml.javax.safetycritical.AperiodicEventHandler.class);
    setReflective(false);
