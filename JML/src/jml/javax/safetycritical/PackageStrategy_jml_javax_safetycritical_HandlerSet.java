 ...
 * package-scope test values for type jml.javax.safetycritical.HandlerSet.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 01:44 +0200
 */
public class PackageStrategy_jml_javax_safetycritical_HandlerSet 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type jml.javax.safetycritical.HandlerSet.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope jml.javax.safetycritical.HandlerSet values or generators here */ });
  }
   ...
   */
  public PackageStrategy_jml_javax_safetycritical_HandlerSet() {
    super(jml.javax.safetycritical.HandlerSet.class);
    setReflective(false);
