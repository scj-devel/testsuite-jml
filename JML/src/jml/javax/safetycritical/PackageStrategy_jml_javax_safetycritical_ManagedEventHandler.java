 ...
 * package-scope test values for type jml.javax.safetycritical.ManagedEventHandler.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 19:04 +0200
 */
public class PackageStrategy_jml_javax_safetycritical_ManagedEventHandler 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type jml.javax.safetycritical.ManagedEventHandler.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope jml.javax.safetycritical.ManagedEventHandler values or generators here */ });
  }
   ...
   */
  public PackageStrategy_jml_javax_safetycritical_ManagedEventHandler() {
    super(jml.javax.safetycritical.ManagedEventHandler.class);
    setReflective(false);
