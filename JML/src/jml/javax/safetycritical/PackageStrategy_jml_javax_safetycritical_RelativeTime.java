 ...
 * package-scope test values for type jml.javax.safetycritical.RelativeTime.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-04-07 16:16 +0200
 */
public class PackageStrategy_jml_javax_safetycritical_RelativeTime 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type jml.javax.safetycritical.RelativeTime.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope jml.javax.safetycritical.RelativeTime values or generators here */ });
  }
  
  /**
   * defaultValues() from RelativeTime; overridden by HSO
   ...
   */
  public PackageStrategy_jml_javax_safetycritical_RelativeTime() {
