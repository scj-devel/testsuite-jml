...
import jml.javax.safetycritical.PackageStrategy_jml_javax_safetycritical_ManagedEventHandler;
/**
 * Test data strategy for jml.javax.safetycritical.PriorityScheduler. Provides
 * class-scope test values for type jml.javax.safetycritical.ManagedEventHandler.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 19:04 +0200
 */
public class ClassStrategy_jml_javax_safetycritical_ManagedEventHandler 
  extends PackageStrategy_jml_javax_safetycritical_ManagedEventHandler {
  /**
   * @return class-scope values for type jml.javax.safetycritical.ManagedEventHandler.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
  	 { /* add class-scope jml.javax.safetycritical.ManagedEventHandler values or generators here */ });
  }

  /**
   * The use of reflection can be controlled here for  
   * parameters of type jml.javax.safetycritical.ManagedEventHandler
   ...
   */
  public ClassStrategy_jml_javax_safetycritical_ManagedEventHandler() {
    super();
    setReflective(false);
