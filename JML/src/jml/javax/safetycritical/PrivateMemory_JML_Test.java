/*
 * Test Oracle Class for jml.javax.safetycritical.PrivateMemory
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-16 14:53 +0200.
...
import jml.javax.safetycritical.PrivateMemory_JML_Data.*;


/**
 * Test oracles generated by JMLUnitNG for JML4 RAC of class
 * jml.javax.safetycritical.PrivateMemory.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-16 14:53 +0200
 */

public class PrivateMemory_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {PrivateMemory_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.PrivateMemory.class),
  ...
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_PrivateMemory__int_size__0")
  public void test_PrivateMemory__int_size__0
  (final int size) {
    try {
      new jml.javax.safetycritical.PrivateMemory(size);
    }
  ...
  /**
   * Data provider for constructor PrivateMemory(int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_PrivateMemory__int_size__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_PrivateMemory__int_size__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (PrivateMemory__int_size__0__size.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(PrivateMemory_InstanceStrategy.class));
  }
}