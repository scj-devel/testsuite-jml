/*
 * Test Oracle Class for jml.javax.safetycritical.Scheduler
 ...
 * jml.javax.safetycritical.Scheduler.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-05-12 17:56 +0200
 */

public class Scheduler_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {Scheduler_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.Scheduler.class),
     "JMLUnitNG tests can only run on RAC-compiled code.");
  } 

  /**
   * A test for method getCurrentSO.
   *
   * @param the_test_object The Scheduler to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_static_getCurrentSO__0
  ( ) {
    try {
      jml.javax.safetycritical.Scheduler.getCurrentSO();
    }
