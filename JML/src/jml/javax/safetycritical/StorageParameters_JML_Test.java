/*
 * Test Oracle Class for jml.javax.safetycritical.StorageParameters
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-17 01:14 +0200.
...
import jml.javax.safetycritical.StorageParameters_JML_Data.*;


/**
 * Test oracles generated by JMLUnitNG for JML4 RAC of class
 * jml.javax.safetycritical.StorageParameters.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-17 01:14 +0200
 */

public class StorageParameters_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {StorageParameters_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.javax.safetycritical.StorageParameters.class),
     "JMLUnitNG tests can only run on RAC-compiled code.");
  } 

  /**
   * A test for method getBackingStoreSize.
   *
   * @param the_test_object The StorageParameters to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getBackingStoreSize__0
  (final jml.javax.safetycritical.StorageParameters the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
      }
    try {
      the_test_object.getBackingStoreSize();
    }
  ...
  /**
   * A test for method getConfigurationSizes.
   *
   * @param the_test_object The StorageParameters to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getConfigurationSizes__0
  (final jml.javax.safetycritical.StorageParameters the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
    ...
    try {
      the_test_object.getConfigurationSizes();
    }
    catch (final JMLEntryPreconditionError $e) {
      // meaningless test
      throw new PreconditionSkipException($e.getMessage());
   ...
   *
   * @param totalBackingStore The long to be passed.
   * @param sizes The long[] to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_StorageParameters__long_totalBackingStore__long1DArray_sizes__0")
  public void test_StorageParameters__long_totalBackingStore__long1DArray_sizes__0
  (final long totalBackingStore, final long[] sizes) {
    try {
      new jml.javax.safetycritical.StorageParameters(totalBackingStore, sizes);
    }
    catch (final JMLEntryPreconditionError $e) {
      // meaningless test
      throw new PreconditionSkipException($e.getMessage());
  ...
  /**
   * Data provider for constructor StorageParameters(long, long[]).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_StorageParameters__long_totalBackingStore__long1DArray_sizes__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_StorageParameters__long_totalBackingStore__long1DArray_sizes__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (StorageParameters__long_totalBackingStore__long1DArray_sizes__0__totalBackingStore.class,
          StorageParameters__long_totalBackingStore__long1DArray_sizes__0__sizes.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(StorageParameters_InstanceStrategy.class));
  }
}