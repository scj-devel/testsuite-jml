/*
 * Test Oracle Class for jml.vm.RealtimeClock
 * For Use With JML4 RAC
 *
 * Generated by JMLUnitNG 1.3 (103), 2013-06-17 07:37 +0200.
 ...
 * jml.vm.RealtimeClock.
 * 
 * @author JMLUnitNG 1.3 (103)
 * @version 2013-06-17 07:37 +0200
 */

public class RealtimeClock_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {RealtimeClock_JML_Test.class};
  ...
  public void test_racEnabled() {
    Assert.assertTrue
    (JMLChecker.isRACCompiled(jml.vm.RealtimeClock.class),
   ...
   *
   * @param the_test_object The RealtimeClock to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_static_instance__0
  ( ) {
    try {
      jml.vm.RealtimeClock.instance();
    }
